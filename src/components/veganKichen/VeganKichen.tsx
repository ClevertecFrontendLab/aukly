...
const vegansList = [
    {
        ...
        body: 'Картошка, тушенная с болгарским перцем, фасолью, морковью и луком, -  вариант сытного блюда на каждый день. Фасоль в данном случае заменяет  мясо, делая рагу сытным и питательным. Чтобы сократить время  приготовления, возьмём консервированную фасоль. Блюдо хоть и простое, но в полной мере наполнено ароматами и имеет выразительный вкус за счёт  добавления томатной пасты.',
        goTo: 'Национальные',
        btnIcon: 'src/assets/image/icons8-bread-96.png',
        image: 'src/assets/image/stewed_potatoes.png',
        count: 85,
        likes: 152,
    },
    {
        ...
        body: 'Рекомендую всем приготовить постное блюдо из картофеля и грибов.  Готовится это блюдо без яиц, без мяса и без сыра, из самых простых  ингредиентов, а получается очень вкусно и сытно. Постный рецепт  картофельных рулетиков с грибами, в томатном соусе, - на обед, ужин и  даже на праздничный стол!',
        goTo: 'Детские блюда',
        btnIcon: 'src/assets/image/icons8-bread-96.png',
        image: 'src/assets/image/potatoes_ruletos.png',
        count: 85,
        likes: 152,
    },
    {
    ...
    },
    {
        ...
        body: 'Большое, сытное блюдо для ценителей блюд без мяса! Такая лазанья  готовится с овощным соусом и соусом бешамель, а вместо листов для  лазаньи используется тонкий лаваш.',
        goTo: 'Блюда на гриле',
        btnIcon: 'src/assets/image/icons8-bread-96.png',
        image: 'src/assets/image/vegetable_lasagna.png',
        count: 85,
        likes: 152,
    },
    {
        id: 5,
        title: 'Пури',
        body: 'Пури - это индийские жареные лепешки, которые готовятся из пресного  теста. Рецепт лепешек пури требует самых доступных ингредиентов, и  времени на приготовление хрустящих лепешек уйдет мало.',
        goTo: 'Национальные',
        btnIcon: 'src/assets/image/icons8-bread-96.png',
        image: 'src/assets/image/puri.png',
        count: 124,
        likes: 352,
    },
    {
    ...
    {
        id: 8,
        title: 'Лапша с курицей и шалфеем',
        body: 'Как раз после праздников, когда мясные продукты еще остались, но никто их уже не хочет, время варить солянку.',
        goTo: 'Вторые блюда',
        btnIcon: 'src/assets/image/icons8-bread-96.png',
        image: 'src/assets/image/rolton_chiken_hafran.png',
        ...
        <>
            ...
            >
                ...
                <GridItem px='3' bg='white' textAlign='center'>
                    <Box>
                        <Box mt={4} mb='32px' w={['320px', 'null', '750px', 'null', '100%']}>
                            <Heading
                            ...
                            <Text
                                ...
                                lineHeight={['143%', '143%', '143%', '150%', '150%', '150%']}
                                fontWeight={500}
                                color='rgba(0, 0, 0, 0.48)'
                                w={['328px', 'null', '696px', 'null', '880px']}
                                margin='0 auto'
                            >
                        ...
                        {/*  */}
                        <HStack justifyContent={['left', 'center']}>
                            <Button
                            ...
                            <InputGroup maxW={['284px', 'null', '458px']}>
                                <Input
                                    placeholder='Название или ингредиент...'
                                    h={['32px', '32px', '32px', '48px', '48px', '48px']}
                                    color='#134b00;'
                                    _placeholder={{ color: 'inherit' }}
                                />
                                <InputRightElement h={['30px', 'null', '48px']}>
                                    <Icon as={SearchIcon} />
                                </InputRightElement>
                            </InputGroup>
                        </HStack>
                    ...
                    <Box mt={6}>
                        <Tabs defaultIndex={2}>
                            <TabList justifyContent='center' overflowX='scroll'>
                                <Tab
                                    fontSize={['14px', '16px']}
                                    lineHeight={['143%', '150%']}
                                    fontWeight={500}
                            ...
                            <TabPanels>
                                ...
                                <TabPanel w={['360px', 'null', '750px', 'null', '100%']}>
                                    <VeganList recipes={vegansList} />
                                    <Box mt={4}>
                                        <Button
                                            as='a'
                                            bg='#b1ff2e'
                    ...
                    <Grid gridTemplateColumns={['1fr', '1fr 1fr', '1fr 1fr', '1fr']} mt={8}>
                                ...
                                >
                                    ...
                                    >
                                        <Button
                                            ...
                                            fontWeight={400}
                                        >
                                            <Image src={iconFirst} /> Детские блюда
                                        </Button>
                                        <HStack>
                                            <Text
                                                color='#2db100;'
                        ...
                        <GridItem colSpan={2}>
                            {/* <Hide below='991px'>
          <Text fontSize='16px' lineHeight='150%' fontWeight={500} color='rgba(0, 0, 0, 0.48)' textAlign='left' noOfLines={[0, 3, 4]} mb={2} ml={2}>
            Без них невозмож444но представить себе ни современную, ни традиционную  кулинарию. Пироги и печенья, блины, пончики, вареники и, конечно, хлеб - рецепты изделий из теста многообразны и невероятно популярны.
          </Text>
        </Hide> */}
                            <Hide above='768px'>
                                <VStack>
                ...
                {/* -------------------------------Blog-------------------------------- */}
                <Hide below='md'>
                    <GridItem pl='2' bg='white' w='280px' h='100vh'>
                        <Flex flexDirection='column' justifyContent='space-between'>
                            <VStack h='calc(100vh - 250px)'>
                                <Button
                                    bg='transparent'
                                    color='#2db100;'
                                    lineHeight='150%;'
