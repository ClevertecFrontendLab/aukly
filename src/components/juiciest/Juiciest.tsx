...
import { RecipeHot } from '~/components/contentApril/RecipeHot';
import Menunos from '~/components/Menunos';

import styles from './juiciest.module.css';
        ...
        <>
            ...
            >
                ...
                <GridItem px='3' bg='white' textAlign='center'>
                    <Box>
                        ...
                        <HStack justifyContent={['left', 'center']}>
                            ...
                            <InputGroup maxW={['284px', 'null', '458px']}>
                                ...
                                />
                                <InputRightElement h={['30px', '30px', '30px', '48px']}>
                                    <Icon as={SearchIcon} />
                                </InputRightElement>
                            </InputGroup>
                        </HStack>
                    ...
                    {/* -------------------------------------Content------------------------------------------ */}
                    <Stack mt={4}>
                        <RecipeHot recipes={juiciestList} />
                        <Box>
                            <Button
                    ...
                    <Divider mt={4} />
                    {/* -------------------------------------------Веганская кухня ----------------------------------- */}
                    <Grid gridTemplateColumns={['1fr', '1fr 1fr', '1fr 1fr', '1fr']} mt={4}>
                        <GridItem>
